                ...
                <div class="col-md-4">
                    ...
                    <div class='d-flex'>
                     <div class='d-flex justify-content-left mt-3'>
                         <form action="{{ route('delete.spend', ['spending' => $params['id']]) }}" method="POST">
                          @csrf
                          <button type="submit" class="btn btn-secondary">削除</button>
                         </form>
                         <a href="{{ route('edit.spend', ['spending' => $params['id']]) }}">
                          <button class='btn btn-secondary'>編集</button>
                         </a>
                         <form action="{{ route('softdelete.spend', ['spending' => $params['id']]) }}" method="POST">
                          @csrf
